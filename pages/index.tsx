      ...
      >
        <div className="p-4 text-center md:p-12 lg:text-left">
          ...
          <div
            ...
            style={{
              backgroundImage: 'url("/austin-headshot.jpg")'
            }}
          />
          <h1 className="pt-8 text-3xl font-bold lg:pt-0">Austin Donnald</h1>
          <div className="w-4/5 pt-3 mx-auto border-b-2 border-teal-500 opacity-25 lg:mx-0" />
          <p className="flex items-center justify-center pt-4 text-base font-bold lg:justify-start">
            <svg
              className="h-4 pr-4 text-teal-700 fill-current"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
            >
              <path d="M9 12H1v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6h-8v2H9v-2zm0-1H0V5c0-1.1.9-2 2-2h4V2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1h4a2 2 0 0 1 2 2v6h-9V9H9v2zm3-8V2H8v1h4z" />
            </svg>
            Customer Success Manager at Cisco
          </p>
          ...
          {/* <div className="pt-12 pb-8">
            <button className="px-4 py-2 font-bold text-white bg-teal-700 rounded-full hover:bg-teal-900">
              Get In Touch
            </button>
          </div> */}
          <div className="flex flex-wrap items-center justify-between w-4/5 pb-16 mx-auto mt-6 lg:pb-0 lg:w-full">
            <a
              className="link"
              href="https://www.linkedin.com/in/austindonnald/"
